    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            ...
            description="I'll collaborate with you to map out your website's goals, target audience, and key functinalities. We will discuss things like site structure, navigation, and content requirements">
             <CanvasRevealEffect
                 animationSpeed={5.1}
        ...
        <Card 
            ...
            description="Once we agree on the plan, i dive straight into coding. From initial sketches to polished code, I keep you updated every step of the way.">
            <CanvasRevealEffect
                animationSpeed={3}
